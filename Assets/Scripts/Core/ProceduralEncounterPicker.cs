...
public class ProceduralEncounterPicker : EncounterPicker {
	...
	/// <summary>Parses the ThemedSession to get the next Storyboard to play. Automatically increments state.</summary>
	public override Storyboard Next {
		get {
	...
	private Storyboard PickStoryboard(List<EncounterListing> weightedValues) {
